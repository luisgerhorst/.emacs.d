(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (git-commit flycheck-rust magit-svn mips-mode ess racer company-racer cargo rust-mode delight esh-autosuggest reveal-in-osx-finder flx-ido ido-completing-read+ ace-window xcscope company-jedi anaconda-mode frame-restore meghanada osx-trash gradle-mode groovy-mode company-emacs-eclim eclim flycheck-irony company ag git-timemachine whole-line-or-region fic-mode yaml-mode projectile ido-vertical-mode flycheck company-irony irony use-package dumb-jump ensime iedit powerline auctex ws-butler which-key vkill visual-fill-column swift-mode solarized-theme smex scss-mode paredit paradox nasm-mode mu4e-alert markdown-mode magit lua-mode fillcode expand-region exec-path-from-shell discover-my-major discover diminish crm-custom company-quickhelp company-c-headers company-auctex avy auto-compile apache-mode aggressive-indent adaptive-wrap)))
